...
- Notion 連携チャット: **http://localhost:3000/agent**
- 従来のチャット: **http://localhost:3000**（FastAPI の `NEXT_PUBLIC_API_URL` が指す URL が起動している必要あり）
...
2. ブラウザで **http://localhost:3000/agent** を開く。
...
- **GET** http://localhost:3000/api/notion-agent-health
