...
export default function Home() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#f5efe6] text-slate-900">
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-5xl items-start justify-center px-4 pb-0 pt-36 md:px-8 md:pb-0 md:pt-44">
        <section className="w-full overflow-hidden rounded-3xl border border-amber-900/10 bg-white/75 shadow-[0_20px_80px_rgba(71,45,24,0.18)] backdrop-blur-2xl">
          ...
          <div className="h-[40vh] min-h-[280px] max-h-[420px] md:h-[44vh] md:min-h-[320px] md:max-h-[500px]">
            <ChatWindow />
          </div>
        </section>
      </div>
