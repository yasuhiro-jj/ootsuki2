...
export default function Home() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#f5efe6] text-slate-900">
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-5xl items-start justify-center px-3 pb-2 pt-24 md:px-8 md:pb-6 md:pt-10">
        <section className="flex h-[calc(100svh-6.5rem)] max-h-[calc(100svh-6.5rem)] w-full flex-col overflow-hidden rounded-[1.75rem] border border-amber-900/10 bg-white/75 shadow-[0_20px_80px_rgba(71,45,24,0.18)] backdrop-blur-2xl md:h-[85vh] md:min-h-[560px] md:max-h-[820px] md:rounded-3xl">
