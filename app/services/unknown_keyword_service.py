...
class UnknownKeywordSearchService:
    ...
    def __init__(self, notion_client: Optional[NotionClient] = None):
        ...
        """
        self.notion_client = notion_client or NotionClient(api_key=settings.notion_api_key)
        self.database_id = settings.notion_database_id_unknown_keywords
    ...
    def should_search(self, rag_results: List[Dict[str, Any]]) -> bool:
        """
        RAG結果に基づいて検索を実行すべきか判定
        ...
        # 将来的に、信頼度が低い場合の判定も追加可能
        # 例: rag_resultsのスコアが低い場合
